    ...
    <body>
        <div id="viewport" style="width:960px;margin:0 auto;">
            ...
            <div>
                ...
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/agrif</pre>
                ...
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?q=fossil</pre>
                <p>(items with <code>fossil</code> anywhere in any field)</p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?q=*</pre>
                <p>(all items)</p>
                ...
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?set=KEEVOSH</pre>
                <p>(items with <code>KEEVOSH</code> anywhere in the <code>set</code> field)</p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?languageBlocks.en.title=oil</pre>
                <p>(items with <code>oil</code> anywhere in the <code>languageBlocks.en.title</code> field)</p>
                <p>Multiple:</p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?expressions.language=en&amp;languageBlocks.en.description=sea</pre>
                ...
                <p>Field &amp; simple:</p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?set=ASETVALUE&amp;q=zebra</pre>
                <p>(items with <code>ASETVALUE</code> in the <code>set</code> and <code>zebra</code> in any field.)</p>
                <p>Boolean:</p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?status=pending+OR+active</pre>
                ...
                <p><strong>Examples:</strong></p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?creationDate=1910-01-01</pre>
                <p>(items that were created on <code>1910</code>)</p>

                <h3 id="search-specific-items">Fetching specific <code>items</code></h3>
                <p>Say you already have the <code><a href="http://dp.la/info/developers/codex/field-reference/#id">id</a></code> for the <code>item</code> you want, and
                    you're just looking to get the rest of the metadata for that item. Simply add the <code>id</code> to the end of the <code>items</code> request. Bonus:
                    You can search for multiple IDs by separating them with a comma (,).</p>
                <p><strong>Example:</strong></p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif/fffffed915b46b7d71bcc8d888900c4b</pre>
                <p>(item with the given <code>id</code>)</p>
                ...
                <p><strong>Examples:</strong></p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?q=fossil&amp;sort_by=languageBlocks.en.title</pre>
                <p>(items with <code>fossil</code> in any field, sorted by the <code>languageBlocks.en.title</code>)</p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?q=fossil&amp;sort_by=creationDate&amp;sort_order=desc</pre>
                <p>(items with <code>fossil</code> in any field, sorted by <code>creationDate</code>)</p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?q=sea&amp;sort_by=languageBlocks.en.title</pre>
                ...
                <p><strong>Examples:</strong></p>
                <p>Basic:</p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?facets=set</pre>
                <p>Multiple:</p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?facets=languageBlocks.en.title,set</pre>
                <p>No Docs:</p>
                <pre style="padding-left: 30px;">http://api.dp.la/dev/items?facets=set&amp;page_size=0</pre>
                <p>Facet Limit:</p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?facets=set&amp;facet_size=3</pre>
                <p>&nbsp;</p>
                ...
                <p><strong>Examples:</strong></p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?q=fossil&amp;page_size=2</pre>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?q=sea&amp;page_size=25</pre>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?q=sea&amp;page_size=25&amp;page=3</pre>
                <p>&nbsp;</p>

                <h3 id="complex">Complex Queries</h3>
                <p>Let's get this APIarty started.</p>
                <p><strong>Examples:</strong></p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?q=sea&amp;languageBlocks.en.title=africa</pre>
                <p><span>(items with both <code>sea</code> in any field and <code>africa</code> in the <code>languageBlocks.en.title</code>)</span></p>
                <pre style="padding-left: 30px;">http://keevosh.ath.forthnet.gr:8088/v1/akif?languageBlocks.en.description=sea+OR+africa&amp;page_size=25</pre>
